...
/*
tsjw:CAN_SJW_1TQ	tbs1:CAN_BS1_2TQ		tbs2:CAN_BS2_2TQ	brp:9		mode:CAN_MODE_NORMAL
*/
u8 CAN1_Mode_Init(u32 tsjw,u32 tbs1,u32 tbs2,u16 brp,u32 mode)
{
    ...
    CAN1_FilerConf.BankNumber=14; //设置CAN2起始存储区
...
void HAL_CAN_RxCpltCallback(CAN_HandleTypeDef* hcan)
{
	...
	/* 数据包传入协议层进行解析 */
	canDispatch(CAN1_Handler.pRxMsg);
}
#endif	
...
{	
    ...
    CAN1_Handler.pTxMsg->ExtId=ID;        //扩展标识符(29位)
